return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>fi", "<cmd>Telescope find_files no_ignore=true <CR>", { desc = "Find files (including ignored)" })
		...
		vim.keymap.set("n", "<leader>fa", builtin.live_grep, { desc = "Live grep (search text in files)" })
